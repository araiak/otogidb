...
If you skipped :card[553] last month, :card[1311] is your best option to get started in Divina while we wait for a strong carry. This is only worth picking up if you play Divina — the self-buff doesn't help other attributes. For new players the skill damage is very strong, but for stronger players this might hit skill damage caps which may mean you don't get the full value of her ability — :card[553] increases both auto attacks and skill damage, so if you are capping skill damage then you are better off with :card[553] for overall damage. **Best Divina carry option if you missed :card[553]; only worth it for Divina players.**
...
**Strong Picks:**
- :card[1311] -- **Best Divina carry if you missed :card[553]** -- high ATK with 60% self skill DMG; only worth it for Divina players, at higher levels :card[553] is better since it buffs both auto and skill damage
