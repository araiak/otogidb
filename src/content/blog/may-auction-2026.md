...
For this auction we expect Welcome to Halloween Tower! and A Visitor from the Outer Space second re-run. The second re-run is a bit more fuzzy, so this may end up being wrong -- I'll update once we know for sure, but for now I'll do the usual beforehand.

First a few updates. I added a new layout style -- the old one "classic" is still the default, but give it a try if you haven't noticed it yet. I felt the old style was a bit flat, which is fine for a data site, but I wanted to see if I could jazz it up just a tad.
...
I don't think any blog post can assess if a card is right for you and your team because everyone is at different points in building their teams. I hope that I can provide feedback aimed toward players who are still progressing their teams, on the f2p or light pay to win scale. My normal recommendations will focus on event progress and overall team strength.
...
I think there are two strong picks from this auction we can start with:

:card[1311] is the top ranking card, and most importantly she was just fixed. While she is not that strong compared to the best carries, she is relatively strong in Divina, and more f2p friendly than other options. Divina has 3 carry options: :card[553], :card[1311], :card[616].
...
:card[1311] is your best Divina carry option — :card[553] may not be back for a long time, so this is the strongest pick available now. This is only worth picking up if you play Divina — other attributes already have stronger carry options. For new players the skill damage is very strong, but for stronger players this might hit skill damage caps which may mean you don't get the full value of her ability — :card[553] increases both auto attacks and skill damage, so if you are capping skill damage then you are better off with :card[553] for overall damage. **Best Divina carry option; :card[553] may not return for a long time, making this the best pick now.**

:card[1307] is actually a 4\* and a jewel pick, but for 1000 jewels this is a steal in reserve for anything multiple waves. :card[1307] gives 10% crit rate to Phantasma every wave, so that means in the current Special Story event he would give 100% crit rate by the time you get to the last wave! Divina has better options with the same in :card[1494] and :card[1540] but until Phantasma gets a card like this, :card[1307] should be locked into your reserve for every multiple wave battle. It was insane how much faster my team cleared when this card was released. A lot of people were also convinced it would be nerfed, especially at 4\*, but it wasn't and now it can be yours too. If you play Phantasma, and a lot of people do because the game has been pushing everyone there, you should consider stretching to get at least a copy of this card. You can PvP orb it up. There isn't a comparable card in Phantasma yet, so even if you are f2p Phantasma player check to see if you have 1000 jewels sitting around, and make sure you don't blow them before the auction -- this card is worth it. **Must-have for Phantasma players; lock into reserve for every multi-wave battle.**

---

## Halloween Tower Cards

:card[1308] is a self crit damage buffer without crit rate boosts. She's not very good, but if you happen to have a lvl 72+ :card[1309] that you are using or want to use then you should pick her up. Her main value is to boost :card[1309]. This probably isn't a combo you should be reaching for, but if the stars happen to align it's not terrible for newer players and certainly the combo is capable of clearing towers and Special Story events. But there are stronger options in Anima, and :card[1308] herself is mostly a sacrifice to make :card[1309] strong, but lack of crit rate on :card[1309] prevents the combo from being especially strong. **Only worth it if you already have :card[1309]; skip otherwise.**
...
:card[1310] gives 15% HP to Phantasma and 35% DMG to Phantasma in the final wave. She is a little weaker than :card[673] overall, but 35% DMG is not bad in 1 wave setups and HP can be a nice little bonus, but it's not worth a lot. The real problem is MLB has a steep price for a card that is good but not excellent. I could see some niche use for World Boss because putting the assist on another card to buff the whole team (including Andromeda) gives her both the HP and the damage buff that's always active, but most teams being mixed means you are probably better off running assists that are not restricted to Phantasma. **Niche World Boss pick; steep MLB price for what it offers.**

:card[1314] is an AoE skill progressive skill damage and crit rate card. The crit rate is a nice change to the formula that makes her very strong in endless or any multi wave content where you want a wave clearer. She is undermined a little bit by :card[1307] since she is very likely to cap crit rate quickly running both. She is a good card, but probably not worth the investment because her niche is not really required. **Good card but skip; crit rate caps with :card[1307].**
...
:card[564] is a 40% full team crit damage buff, this is very strong on its own. It could be a good pick if you need more crit damage or if 3-carry teams become a thing — the full team coverage matters in those setups. But since you want a spread of buff types across your assists, and :card[723] and :card[643] are solid assist cards that cover the same niche, they're probably the safer bet for most players. **Strong card but safe to skip; consider if you need more crit damage or plan 3-carry teams.**

:card[565] is a decent healer -- 50% ATK speed increases healing throughput which can sometimes mean the difference between needing something defensive and running more damage. It's also not uncommon to use ATK speed on healers to get throughput which could mean swapping to a better assist bond. 20% DMG to all team members is a bit low but at least it's not an attribute restricted. She's actually a nice pick for newer players: the ATK speed is accessible early, meaning solid healing throughput, and her skill can save a low HP card in tough fights. That contrasts sharply with :card[1618] from this event — she's a very strong offensive pick but has poor throughput. Still, I can't really recommend spending jewels on :card[565] for that reason — this is probably not even worth it. Note that :card[1618] is free in the current event (though it may be leaving by the time this goes up), so if you want a strong offensive pick grab it while you can. If you're looking for higher throughput f2p offensive options consider :card[2185] or :card[655], and for f2p defensive options :card[526] is a solid choice. **Good for newer players, but there are better f2p options; probably not worth spending jewels.**
...
**Strong Picks:**
- :card[1311] -- **Best Divina carry** -- high ATK with 60% self skill DMG; :card[553] may not return for a long time, making this the best pick now; only worth it for Divina players
- :card[1307] -- **Must-have for Phantasma** -- 4* jewel pick at 1000 jewels; progressive crit rate to Phantasma every wave; lock in reserve for multi-wave content
...
- :card[565] -- **Good for newer players, but better f2p options exist** -- accessible ATK speed means solid throughput, skill can save a low HP card in tough fights; contrasts with strong but low-throughput :card[1618]; probably not worth spending jewels
