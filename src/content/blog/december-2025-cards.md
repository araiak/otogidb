---
title: "December 2025: Christmas Cards & Auction Analysis"
...
:card[1435] is essentially a Divina version of :card[1312]'s skill (hitting 3 enemies with highest ATK) that increases in damage wave over wave. He looks like he's balanced to be a Special Story card, so he may be accessible to newer players, and only requires 3 copies to get the skill which is... fine, I guess.
...
:card[1438] is another interesting card. Melee are generally not very popular, but she has a strong skill, and self buff over time like :card[628] with built-in defensive ability could make her useful to players for endless. But she probably requires too many copies to be interesting to most players, and is probably not strong enough to orb. Even her damage down requires 3 copies, which is just too many.

:card[1992] looks like maybe a ranking card and is an ok Phantasma healer. The skill is ok, but I think 1-target crit rate like :card[655] is generally less favorable than 2+ target crit rate since 2-target buffs like :card[664], :card[723] (Lv. 72 ability), and :card[643] all enable and encourage moving from one carry to two in a lot of content. The MLB ability is decent, you could argue it's better than :card[2373] but in practice most of your damage is coming from crits from one or two carries. The card might be more accessible but at 5 copies to unlock the ability most players might be waiting for auction.
...
クリスマスカードと12月のオークションが開催中なので、これらのカードについて個人的なメモを残したいと思います。すべてのカードを網羅するわけではなく、より関連性が高いか目を引くものだけを取り上げます。カードの完全な情報は[カード](/)と[アップデート](/updates)ページで確認できます。
...
Las cartas navideñas y las subastas de diciembre están activas, así que quería dejar algunas notas personales sobre estas cartas. No cubriré todas las cartas, solo las más relevantes o llamativas - la información completa está disponible en las páginas de [Cartas](/) y [Actualizaciones](/updates).

## Sobre mí

Primero, dado que esta es una de mis primeras publicaciones, daré algo de contexto sobre mi experiencia como jugador. Jugué el AGG original cuando estaba activo y eventualmente lo dejé. Hace unos 8 meses descubrí Otogi como una especie de remake de AGG y me uní, los primeros eventos en los que participé ahora están apareciendo en subasta.

He quedado en el top 80 general en algunos eventos recientes, y estoy alrededor del puesto 200 en los rankings de World Boss aunque no estoy construyendo ni poniendo mucho esfuerzo en esos rankings. Así que tengo un equipo bastante fuerte, pero no estoy en la vanguardia del "meta". Empecé jugando Divina, pero recientemente cambié principalmente a Phantasma. Mi equipo Anima es bastante débil y no tengo Sola, así que no tengo mucho conocimiento del "meta" sobre equipos Anima. En cualquier caso, quiero compartir mis pensamientos sobre estas cartas.
...
:card[1438] es otra carta interesante. Las melees generalmente no son muy populares, pero tiene un skill fuerte, y el auto-buff con el tiempo como :card[628] con habilidad defensiva incorporada podría hacer esta carta útil para contenido infinito. Pero probablemente requiere demasiadas copias para ser interesante para la mayoría de jugadores, y probablemente no es lo suficientemente fuerte para orbe. Incluso su reducción de daño requiere 3 copias, lo cual es demasiado.

:card[1992] parece ser una carta de ranking y es un sanador Phantasma decente. El skill está bien, pero creo que la tasa de crítico para 1 objetivo como :card[655] es generalmente menos favorable que la tasa de crítico para 2+ objetivos ya que buffs de 2 objetivos como :card[664], :card[723] (habilidad Lv. 72), y :card[643] todos permiten y fomentan pasar de un carry a dos en mucho contenido. La habilidad MLB es decente, podrías argumentar que es mejor que :card[2373] pero en la práctica la mayor parte del daño viene de críticos de uno o dos carries. La carta podría ser más accesible pero con 5 copias para desbloquear la habilidad, la mayoría de jugadores probablemente esperarán la subasta.
...
:card[664] es una adición permanente y probablemente **compra obligatoria para casi todos**. El costo inicial es bastante alto, pero puedes sellar y vender copias después lo que casi convertirá cualquier reserva o soporte en :card[672] por el costo de unos pocos cientos de mochi.
...
*Una nota sobre las recomendaciones: ¡Juega como quieras! Si quieres una carta, ve a por ella. Mis recomendaciones destacan cartas que considero sobresalientes - que probablemente no serán reemplazadas pronto - mientras considero el costo. El juego es bastante generoso, así que puedes conseguir cartas que no sean súper fuertes y aún tener recursos para el siguiente evento. ¡No dudes en comprar una carta que te guste!*
