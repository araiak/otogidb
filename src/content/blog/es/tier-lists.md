...
**Las habilidades de sanador están infravaloradas.** La simulación usa la lógica de AUTO, que prioriza las habilidades de daño sobre las curaciones y buffs. Más significativamente, el juego tiene un sistema de energía oculto donde las unidades acumulan energía a través de ataques automáticos o curaciones antes de activar sus habilidades. Los sanadores típicamente tienen mayor velocidad, lo que significa que generan energía más lentamente en relación a su frecuencia de ataque y usan sus habilidades con menos frecuencia en modo AUTO. Puedes observar esto en peleas largas usando AUTO - los sanadores frecuentemente muestran conteos de uso de habilidades más bajos porque no están activando habilidades tan seguido. El juego manual que prioriza las habilidades de sanador mostraría mejores resultados de lo que la simulación sugiere.
