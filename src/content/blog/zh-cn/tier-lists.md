...
**治疗技能被低估了。** 模拟使用AUTO逻辑，将治疗和增益的优先级置于伤害技能之后。更重要的是，游戏有一个隐藏的能量系统，单位需要通过普通攻击或治疗积累能量才能触发技能。治疗通常速度较高，这意味着相对于攻击频率他们的能量生成较慢，在AUTO模式下使用技能的频率更低。你可以在使用AUTO的长时间战斗中观察到这一点——治疗经常显示较低的技能使用次数，因为他们触发技能的频率不高。优先使用治疗技能的手动操作会比模拟显示的结果更好。
